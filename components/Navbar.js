    ...
    <header style={{ position: 'sticky', top: 0, zIndex: 20, background: 'rgba(255,255,255,0.96)', borderBottom: '1px solid #E5E7EB', backdropFilter: 'blur(10px)' }}>
      <nav style={{ maxWidth: 1120, margin: '0 auto', padding: '0.85rem 1rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <Link href="/solutions" style={linkStyle}>Solutions</Link>
          <Link href="/use-cases" style={linkStyle}>Use Cases</Link>
          <Link href="/materials" style={linkStyle}>Materials</Link>
          <Link href="/cases" style={linkStyle}>Cases</Link>
          <Link href="/ai-tools" style={linkStyle}>AI</Link>
          <Link href="/trust" style={linkStyle}>Trust</Link>
