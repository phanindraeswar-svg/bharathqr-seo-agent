    ...
    <>
      ...
      <div style={{ maxWidth: '740px', margin: '5rem auto', padding: '0 1.5rem', fontFamily: 'system-ui, sans-serif' }}>
        ...
        <div style={{ background: '#fafaf8', border: '1px solid #e8e8e4', borderRadius: '16px', padding: '1.5rem', textAlign: 'center' }}>
          <h3 style={{ fontSize: '16px', color: '#111', marginBottom: '0.5rem' }}>Need an instant payment code for your business?</h3>
          <p style={{ fontSize: '13px', color: '#666', marginBottom: '1.25rem' }}>Generate a completely free, zero-fee custom UPI QR sticker instantly.</p>
